...
export default function Symbol({color = "currentColor", width = "w", height = "h", className = ""}) {
    return (
        <svg className={className} width={width} height={height} viewBox="0 0 24 24" fill={color}
            ...
            <path d="M22.5,8H9.5a1.5,1.5,0,0,0,0,3h13a1.5,1.5,0,0,0,0-3Z" fill={color}/>
            <path d="M22.5,18H9.5a1.5,1.5,0,0,0,0,3h13a1.5,1.5,0,0,0,0-3Z" fill={color}/>
